  ...
  return (
    <View style={{
      ...
      <View style={{ padding: '14px 16px' }}>
        <Text style={{ fontSize: 15, fontWeight: 700, color: '#F0F0F0', marginBottom: 6 }}>
          {space.name}
        </Text>
        {isMortgaged && (
          <Text style={{ fontSize: 11, color: '#3B82F6', fontWeight: 600, marginBottom: 4 }}>
            🔴 Mortgaged
          </Text>
        )}
        ...
        {hasHotel && (
          <Text style={{ fontSize: 12, color: '#3B82F6', fontWeight: 600, marginBottom: 4 }}>🏨 Hotel</Text>
        )}
        {houses > 0 && !hasHotel && (
        ...
        {rentTable && (
          <View style={{ marginTop: 4 }}>
            <Text style={{ fontSize: 10, color: '#A0A0A0', marginBottom: 2 }}>Rent:</Text>
            <Text style={{ fontSize: 10, color: '#A0A0A0' }}>
              Base: ${rentTable[0]}
        ...
        {space.type === 'railroad' && (
          <View style={{ marginTop: 4 }}>
            <Text style={{ fontSize: 11, color: '#A0A0A0', marginBottom: 2 }}>Rent:</Text>
        ...
        {space.price && (
          <Text style={{ fontSize: 10, color: '#A0A0A0', marginTop: 6 }}>
